...
5. 최근 검색어를 선택하면, 최근 검색어 목록을 확인 할 수 있다.
    - [ ] [조건] 최근 검색어는 탭 아래에 위치한다. (검색어, 검색일자, 삭제버튼으로 구성되어 있다.)
    - [ ] [조건] 목록에서 최근 검색어를 선택하면, 검색 결과 화면으로 이동한다.
    - [ ] [조건] 목록에서 최근 검색어를 선택하면, 검색 폼에 선택된 추천 검색어가 나타난다.
    - [ ] [조건] 목록에서 x 버튼을 클릭하면, 최근 검색어를 삭제할 수 있다.
    - [ ] [조건] 검색시마다 최근 검색어 목록에 추가된다.
